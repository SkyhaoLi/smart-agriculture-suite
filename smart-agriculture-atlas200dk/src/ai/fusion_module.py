...
class FusionModule:
    ...
    def __init__(self, data_dir: str = DATA_DIR):
        ...
        self._prediction_boost = 0.0  # 世界模型预测风险加成
    ...
    def _init_channels(self):
        configs = [
            ...
            ("Liquid", "Liquid", "%", 50.0, 0.0, 0.0, 100.0),
        ]
        self._channels = [
    ...
    def _perform_fusion(self) -> FusionResult:
        ...
        result.final_score = result.weighted_score * self.WEIGHTED_RATIO + result.nn_score * self.NN_RATIO + self._prediction_boost
        result.need_score = result.final_score

        if result.final_score > 65.0:
